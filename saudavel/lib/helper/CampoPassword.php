<?php
class CampoPassword extends Artefato
{


	function __construct($label, $name, $observacao = false, $obrigatorio = false, $param = array(), $posTexto = '', $mascara = '') {
		...
		$this->conteudo = "
			<div class='div_linha' {$div}>
				...
				<div class='linha_campo_input'><input class='texto' type='password' style='text-align: left;' name='{$name}' id='{$name}' {$input}/> {$posTexto}</div>
			</div>";
	}
